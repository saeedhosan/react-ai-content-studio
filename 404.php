                ...
                <div class="row">
                    <div class="col-lg-8 col-12 col-sm-10 offset-lg-2 offset-sm-1">
                        <h1 class="m-0">
                            404 </h1>
                        <h6>
                            Ooops! Looks like it is not here </h6>
                        <p>Keep searching and you will find it one day, we all do!</p>
                        <a href="<?= get_site_url(); ?>" class="btn btn-primary special-action-button mt-3">Back to Home</a>
                    </div>
                </div>
            </div>
        </div>
