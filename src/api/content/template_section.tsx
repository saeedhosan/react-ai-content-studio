  ...
  templates: [
    {
      ...
      text: `Make blogging fast and easy with ${settings.app_name}. Get creative, fresh titles with our state of the art technology!`,
      category: `blog`,
    },
    {
      _url: `blog-sections`,
    ...
    },
    {
      ...
      text: `Write great blog intros in seconds - ${settings.app_name} creates the perfect starts to your blog posts!`,
      category: `blog`,
    },
    {
    ...
    },
    {
      ...
      text: `Get great cold emails now! Just click a button and have ${settings.app_name} write it for you!`,
      category: `email`,
    },
    {
      _url: `flow-up-emails`,
    ...
    },
    {
      ...
      text: `Engage with your audience on Instagram with intriguing captions written for you by ${settings.app_name}`,
      category: `social-media`,
    },
    {
      ...
      icon: `fa-brands fa-instagram social-icon`,
      text: `Don't know what hashtags to use to make your Instagram posts easy to find? Let ${settings.app_name} do it for you!`,
      category: `social-media`,
    },
    {
    ...
    },
    {
      ...
      icon: `fa-brands fa-facebook social-icon`,
      text: `Generate amazing, eyeball grabbing Facebook headlines in seconds right inside your ${settings.app_name} account.`,
      category: `social-media`,
    },
    {
