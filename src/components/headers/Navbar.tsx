...
export default function Navbar() {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light w-100" id="navbar-responsive">
            ...
            <div className="collapse navbar-collapse section-links" id="navbarNav">
                <ul className="navbar-nav">
                    <MenuItem name="Home" path={"#main-wrapper"} classes="nav-link scroll active" />
                    <MenuItem name="prices" path={"#prices-wrapper"} classes="nav-link scroll" />
                    <MenuItem name="features" path={"#features"} classes="nav-link scroll" />
                    <MenuItem name="faqs" path={"#faq-wrapper"} classes="nav-link scroll" />
                    <MenuItem
                        name="contact us"
                        path={"#contact-wrapper"}
                        classes="nav-link scroll"
                    />
                    <MenuItem name="blogs" path={"#blog-wrapper"} classes="nav-link scroll" />
                    {!user ? (
                        <>
                            <MenuItem
                                sync
